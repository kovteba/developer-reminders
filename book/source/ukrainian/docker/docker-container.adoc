...
image::docker/docker-container.jpg[Docker Container, align="center"]
...
* Невірна команда <<docker-dockerfile-entrypoint,ENTRYPOINT>> або <<docker-dockerfile-cmd,CMD>> в Dockerfile;
