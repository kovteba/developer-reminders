...
ifndef::dequedir[:dequedir: ../../../../../../../../../../examples/java/src/main/java/kovteba/collectionframework/iterable/collection/queue/deque]
ifndef::dequetestdir[:dequetestdir: ../../../../../../../../../../examples/java/src/main/java/kovteba/collectionframework/iterable/collection/queue/deque]

[[java-collection-framework-deque-vs-queue]]
.Deque vs Queue — перекриваючі методи
...
[#java-collection-framework-deque-interface-methods]
.Методи інтерфейсу `Deque`:
...
NOTE: `Deque` є *рекомендованою заміною* застарілому класу `Stack`. `ArrayDeque` реалізує `Deque` і є швидшою за `Stack` і `LinkedList` для використання як стек.

include::arraydeque/collection-framework-class-arraydeque.adoc[]
