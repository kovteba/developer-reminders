...
ifndef::factorymethodexampledir[:factorymethodexampledir: ../../../../../../examples/design-patterns/factory-method/src/main/java/kovteba]

[#design-pattern-factory-method]
==== Factory Method

image::architecture/designpattern/creational/design-patterns-factory-method.jpg[Factory Method, align="center"]
...
[source,java]
----
include::{factorymethodexampledir}/notification/Notification.java[tags=Notification]
----

[source,java]
----
include::{factorymethodexampledir}/notification/impl/SMSNotification.java[tags=SMSNotification]
----

[source,java]
----
include::{factorymethodexampledir}/notification/impl/EmailNotification.java[tags=EmailNotification]
----

[source,java]
----
include::{factorymethodexampledir}/factory/NotificationFactory.java[tags=NotificationFactory]
----

[source,java]
----
include::{factorymethodexampledir}/factory/impl/SMSNotificationFactory.java[tags=SMSNotificationFactory]
----

[source,java]
----
include::{factorymethodexampledir}/factory/impl/EmailNotificationFactory.java[tags=EmailNotificationFactory]
----

[source,java]
----
include::{factorymethodexampledir}/FactoryMethodDemo.java[tags=FactoryMethodDemo]
----
